...
def main():
  ...
  DFG_CLUSTRNG_KERNEL = DFG_CLUSTRNG_HOME + '/applications/picojpeg_idct_cols/'
  MAPPER_KERNEL = MAPPER_HOME + '/applications/clustered_arch/picojpeg_idct_cols/'
...
##############################################################################################################################################
  ...
  os.system('cp idctCols_INNERMOST_LN1_PartPred_DFG_forclustering.xml '+DFG_CLUSTRNG_KERNEL)
  os.system('cp idctCols_INNERMOST_LN1_PartPred_DFG.xml '+ MAPPER_KERNEL)

  print('\nRunning DFG Clustering\n')
  os.chdir(DFG_CLUSTRNG_KERNEL)
  #os.system('python ../../dfg_clustering.py idctCols_INNERMOST_LN1_PartPred_DFG_forclustering.xml 8 %s 100' % ("precomputed"))
  os.system('dot -Tpdf inter_cluster.dot -o inter_cluster_graph_idct_cols.pdf')
  os.system('dot -Tpng inter_cluster.dot -o inter_cluster_graph_idct_cols.png')
  ...
  #os.system('python ../../cluster_level_mapping_spkmModified.py 3 3 3 3')
...
##############################################################################################################################################
  ...
  os.system(HIMAP2_HOME+'/Morpher_CGRA_Mapper/build/src/cgra_xml_mapper  -d idctCols_INNERMOST_LN1_PartPred_DFG.xml -j '+HIMAP2_HOME+'/Morpher_CGRA_Mapper/json_arch/clustered_archs/stdnoc_3x3tiles_3x3PEs.json')
  os.system('neato -Tpdf %s -o %s' % ('arch_allconnections.dot','stdnoc_3x3tiles_4x4PEs_v2.pdf'))
  os.system('neato -Tpdf %s -o %s' % ('arch_interclusterconnections.dot','stdnoc_3x3tiles_4x4PEs_interclusterconnections_v2.pdf'))
  os.system('neato -Tpng %s -o %s' % ('arch_allconnections.dot','stdnoc_3x3tiles_4x4PEs_v2.png'))
  os.system('neato -Tpng %s -o %s' % ('arch_interclusterconnections.dot','stdnoc_3x3tiles_4x4PEs_interclusterconnections_v2.png'))
