...
def main():
    ...
    #mapping_file = '/home/dmd/Workplace/HiMap2/Morpher_CGRA_Mapper/applications/clustered_arch/edn/jpegdct_POST_LN111_PartPred_DFG.xmlstdnoc_3x3tiles_3x3PEs.json_MTP=1_Iter=5.mappingwithlatency_skipINTER.txt'

    mapping_file = '/home/dmd/Workplace/HiMap2/Morpher_CGRA_Mapper/applications/clustered_arch/edn/jpegdct_POST_LN111_PartPred_DFG.xmlstdnoc_3x3tiles_3x3PEs.json_MTP=1_Iter=0.mappingwithlatency_skipINTRA.txt'
    ...
    # plot vertices
    ax.scatter(pe_x,pe_y,lat, marker='o',c = group, s = 64)    # c = group, s = 64)    
    # plot edges
    edge_col = Line3DCollection(segments, lw=0.2)
    ax.add_collection3d(edge_col)
    # add vertices annotation.
