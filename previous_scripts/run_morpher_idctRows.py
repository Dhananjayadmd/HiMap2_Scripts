...
def main():
  ...
  DFG_CLUSTRNG_KERNEL = DFG_CLUSTRNG_HOME + '/applications/picojpeg_idct_rows/'
  MAPPER_KERNEL = MAPPER_HOME + '/applications/clustered_arch/picojpeg_idct_rows/'
...
##############################################################################################################################################
  ...
  os.system('cp idctRows_INNERMOST_LN1_PartPred_DFG_forclustering.xml '+DFG_CLUSTRNG_KERNEL)
  os.system('cp idctRows_INNERMOST_LN1_PartPred_DFG.xml '+ MAPPER_KERNEL)

  print('\nRunning DFG Clustering\n')
  os.chdir(DFG_CLUSTRNG_KERNEL)
  #os.system('python ../../dfg_clustering.py idctRows_INNERMOST_LN1_PartPred_DFG_forclustering.xml 10 %s 100' % ("precomputed"))
  os.system('dot -Tpdf inter_cluster.dot -o inter_cluster_graph_idct_rows.pdf')
  os.system('dot -Tpng inter_cluster.dot -o inter_cluster_graph_idct_rows.png')
...
##############################################################################################################################################
  ...
  os.system(HIMAP2_HOME+'/Morpher_CGRA_Mapper/build/src/cgra_xml_mapper  -d idctRows_INNERMOST_LN1_PartPred_DFG.xml -j '+HIMAP2_HOME+'/Morpher_CGRA_Mapper/json_arch/clustered_archs/stdnoc_3x3tiles_3x3PEs.json')
