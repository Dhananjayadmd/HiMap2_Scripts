...
def main():
  ...
  DFG_CLUSTRNG_KERNEL = DFG_CLUSTRNG_HOME + '/applications/aes_encrypt/'
  MAPPER_KERNEL = MAPPER_HOME + '/applications/clustered_arch/aes_encrypt/'
...
##############################################################################################################################################
  ...
  #os.system('python ../../dfg_clustering.py encrypt_INNERMOST_LN1_PartPred_DFG_forclustering.xml 7 %s 100' % ('precomputed'))
  os.system('dot -Tpdf inter_cluster.dot -o inter_cluster_graph_aes_encrypt_7_100.pdf')
...
##############################################################################################################################################
  ...
  os.system(HIMAP2_HOME+'/Morpher_CGRA_Mapper/build/src/cgra_xml_mapper  -d encrypt_INNERMOST_LN1_PartPred_DFG.xml -j '+HIMAP2_HOME+'/Morpher_CGRA_Mapper/json_arch/clustered_archs/stdnoc_3x3tiles_3x3PEs.json')
