...
##############################################################################################################################################
  ...
  os.system('python ../../../dfg_clustering.py idctCols_INNERMOST_LN1_PartPred_DFG_forclustering.xml %s %s %s > log1.txt' % (no_clusters, ('precomputed'), no_init))
