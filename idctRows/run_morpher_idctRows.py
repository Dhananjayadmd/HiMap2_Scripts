...
##############################################################################################################################################
  ...
  os.system('python ../../../dfg_clustering.py idctRows_INNERMOST_LN1_PartPred_DFG_forclustering_removed_falselsdep.xml %s %s %s > log1.txt' % (no_clusters, ('precomputed'), no_init))
