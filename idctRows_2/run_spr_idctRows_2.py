...
##############################################################################################################################################
  ...
  os.system('cp idctRows_unrolled_2_INNERMOST_LN1_PartPred_DFG_forclustering_removed_falsedep.xml '+DFG_CLUSTRNG_KERNEL)
  os.system('cp idctRows_unrolled_2_INNERMOST_LN1_PartPred_DFG_removed_falsedep.xml '+ MAPPER_KERNEL)

  print('\nRunning DFG Clustering\n')
  os.chdir(DFG_CLUSTRNG_KERNEL)
  os.system('python ../../../dfg_clustering.py idctRows_unrolled_2_INNERMOST_LN1_PartPred_DFG_forclustering_removed_falsedep.xml %s %s %s %s > log1.txt' % (no_clusters, ('precomputed'), no_init, cgra_cluster_r))
